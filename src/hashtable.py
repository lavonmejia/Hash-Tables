...
class HashTable:
    ...
    def insert(self, key, value):
        ...
        storage_location = self._hash_mod(key)
    ...
    def remove(self, key):
        ...
        elif self.storage[storage_location].next is None:
            self.storage[storage_location] = None


        else:
            prev = None
            node = self.storage[storage_location]
            while True:
                # prev = node
                if node.key == key:
                    if node.next is None:
